...
if __name__ == "__main__":
  try:
    images_dir = "./Brain-Intracranial-Hemorrhage/images/"
    masks_dir  = "./Brain-Intracranial-Hemorrhage/masks/"
    output_dir = "./Augmented-Brain-Intracranial-Hemorrhage-ImageMask-Dataset/"
